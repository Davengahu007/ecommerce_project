<?php
	...
	if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
	  ...
	  $stmt = $conn->prepare('INSERT INTO orders (name,username,address,pmode,products,amount_paid)VALUES(?,?,?,?,?,?)');
	  $stmt->bind_param('ssssss',$name,$username,$address,$pmode,$products,$grand_total);
	  $stmt->execute();
